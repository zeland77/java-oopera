...
public class Theatre {
    ...
    public static void main(String[] args) {
        ...
        Opera opera = new Opera("Пиковая дама", 210, director2, new ArrayList<>(), musicAuthor,
                            "Весна. Летний сад. Площадка. На скамейкaх сидят и\n" +
                                       "расхаживают нянюшки, гувернантки и кормилицы. Дети\n" +
                                       "играют в горелки, прыгают через веревку, бросают мячи и прочее", 11);
        ...
        Ballet ballet = new Ballet("Щелкунчик", 96, director1, new ArrayList<>(), musicAuthor,
                            "На Рождество в доме Штальбаумов собираются гости. Крёстный Дроссельмейер\n" +
                                    "дарит детям подарки, среди которых — Щелкунчик. Маша привязывается\n" +
                                    "к уродливой кукле. Ночью Маша возвращается в гостиную, где начинается\n" +
                                    "битва мышей во главе с Мышиным королем против армии игрушек, возглавляемой\n" +
                                    "Щелкунчиком. Маша спасает Щелкунчика, бросив в мышей туфельку.", choreographer);
